...
100.times do
  ...
  m = Movie.create(name:mov_name,description:quote,rating:rate,genre:random_option,language:random_lang,director:dir,release_date:random_date,run_time:random_hours)
